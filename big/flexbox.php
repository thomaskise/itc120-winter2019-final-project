...
<section>
    ...
    <p>
        ...
        The basic declaration for flexbox is either display: flex; or display: inline-flex; The difference is comparable to block vs inline-block declaration (Stackoverflow).<br /><br />
...
<aside>
    <h2>Works Cited</h2>
    <p>MDN web docs: “Basic concepts of flexbox”, https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox; not dated; accessed 24 February 2019.</p>
    <p>CSS-Tricks: “A Complete Guide to Flexbox” https://css-tricks.com/snippets/css/a-guide-to-flexbox/; updated 31 January 2019; accessed 20 February 2019.</p>
    <p>Stack Overflow: “What's the difference between display:inline-flex and display:flex”, https://stackoverflow.com/questions/27418104/whats-the-difference-between-displayinline-flex-and-displayflex ; posting dated 21 March 2018; accessed 24 February 2019.</p>
